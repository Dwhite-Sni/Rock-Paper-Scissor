...
Randomly selects the computer's choice each round.
Displays both choices and declares the round winner.
Tracks wins, losses, and draws.
Displays a final scoreboard and announces the winner.
Adds a fun taunting or congratulatory message at the end.